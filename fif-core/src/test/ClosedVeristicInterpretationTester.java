...
public class ClosedVeristicInterpretationTester extends TestCase {
	...
	public void setUp() throws Exception {
		...
		m=new Metadata(att1,fs1,ClosedVeristicInterpretation.getinstance());
		m2=new Metadata(att1,fs2,ClosedVeristicInterpretation.getinstance());
	...
	public void test3() throws Exception {
		...
		assertTrue(arrotonda(f1.doFilter(r),14)==arrotonda((1.33/3.43),14));
	}
	...
	public void test4() throws Exception {
		...
		assertTrue(arrotonda(f1.doFilter(r),14)==arrotonda((1.47/3.94),14));
	}
	...
	public void test5() throws Exception {
		...
		assertTrue(arrotonda(f1.doFilter(r),14)==arrotonda((1.33/2.53),14));
	}
